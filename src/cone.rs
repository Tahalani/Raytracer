...
impl Cone {
    pub fn init_cone (center: Point3D, radius: f64, intersection_point: Point3D) -> Cone {
        Cone { center, radius, intersection_point, rgb: RGB::init_rgb(255, 0, 255), normal: Vector::init_vector(0.0, 0.0, 0.0),
